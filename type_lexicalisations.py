...
if __name__ == '__main__':
    ...
    util.get_logger().info('Started extraction of type lexicalisations.')

    extract_type_lexicalisations()

    duration = (datetime.datetime.now() - now).seconds // 60
    util.get_logger().info(f'Finished extraction of type lexicalisations after {duration} minutes.')
